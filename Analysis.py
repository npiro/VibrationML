...
#%%
fileNormal1 = 'TimeFrames_C043_1.pkl'

fileNormal2 = 'TimeFrames_C044_afterAnomalyRemoved.pkl'

fileNormal3 = 'TimeFrames_C052_afterAnomalyRemoved.pkl'


fileAnomalySmall = 'TimeFrames_C052_tapeAnomaly.pkl'

fileAnomalyLarge = 'TimeFrames_C044_anom.pkl'

with open(fileNormal1, 'r') as f:
    framesNor = pickle.load(f)

with open(fileNormal2, 'r') as f:
    framesNor2 = pickle.load(f)
  
with open(fileNormal3, 'r') as f:
    framesNor3 = pickle.load(f)
    
with open(fileAnomalySmall, 'r') as f:
    framesAno = pickle.load(f)
    
with open(fileAnomalyLarge, 'r') as f:
    framesAnoLarge = pickle.load(f)
